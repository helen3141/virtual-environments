...
Enable-WindowsOptionalFeature -Name NET-Framework-Features -IncludeAllSubFeature
Enable-WindowsOptionalFeature -Name NET-Framework-45-Features -IncludeAllSubFeature
if (Test-IsWin16) {
    Enable-WindowsOptionalFeature -Name BITS -IncludeAllSubFeature
    Enable-WindowsOptionalFeature -Name DSC-Service
}

# Install FS-iSCSITarget-Server
$fsResult = Enable-WindowsOptionalFeature -Name FS-iSCSITarget-Server -IncludeAllSubFeature -IncludeManagementTools
if ( $fsResult.Success ) {
